...
import { search_friends_by_username, send_request, reject_request, accept_friendship, remove_friendship } from '../controllers/friend-controller'
...
router.put('/remove-friendship', is_auth, remove_friendship)
